...
#shoes-screen .shoes-img img {
    max-width: 100%; /* Image width doesn’t exceed container width */
    max-height: 100%; /* Image height doesn’t exceed container height */
    width: auto; /* Maintain aspect ratio */
    height: auto; /* Maintain aspect ratio */
    object-fit: cover; /* Crops the image if needed to fill container */
}
...
<body>
    ...
    <div class="container">
        ...
        <h2 class="d-none">{{ $category->categoryname }}</h2>
                        ...
                        <div class="shoes-screen-bottom-full">
                            ...
                            <div class="shoes-screen-second">
                                ...
                                <div class="shoes-screen-second-full">
                                    <span class="cloth-star">
                                        <img src="{{ asset('assets/images/icons/orange-star.svg') }}" alt="star-img">
                                    </span>
