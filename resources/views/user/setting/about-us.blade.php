						...
						<div class="social-detail-about ">
							<div class="shape facebook-bg">
								<a href="https://www.facebook.com/" target="_blank" >
									<img src="{{asset('')}}assets/images/about-us-page/facebook.svg" alt="facebook">
								</a>
							</div>
							<div>
						...
						<div class="social-detail-about ">
							<div class="shape instragram-bg">
								<a href="https://www.instagram.com/" target="_blank">
									<img src="{{asset('')}}assets/images/about-us-page/instragram.svg" alt="instagram">
								</a>
							</div>
							<div>
						...
						<div class="social-detail-about ">
							<div class="shape twitter-bg">
								<a href="https://twitter.com/" target="_blank" >
									<img src="{{asset('')}}assets/images/about-us-page/twitter.svg" alt="twitter">
								</a>
							</div>
							<div>
						...
						<div class="social-detail-about ">
							<div class="shape youtube-bg">
								<a href="https://www.youtube.com/" target="_blank" >
									<img src="{{asset('')}}assets/images/about-us-page/youtube.svg" alt="youtube">
								</a>
							</div>
							<div>
