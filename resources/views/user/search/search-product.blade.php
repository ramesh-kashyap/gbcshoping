                    ...
                    <div class="dropdown">
                        <div class="setting-page-full">
                            <div class="setting-page-wrapper">
                                ...
                                <a href="{{route('notification-option')}}" class="mt-8">
                                    <div class="setting-deatils">
                                        <div class="setting-icon">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="{{route('langauge')}}" class="mt-8">
                                    <div class="setting-deatils">
                                        <div class="setting-icon">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="{{route('currency')}}" class="mt-8">
                                    <div class="setting-deatils">
                                        <div class="setting-icon">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="{{route('about-us')}}" class="mt-8">
                                    <div class="setting-deatils">
                                        <div class="setting-icon">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="{{route('privacy')}}" class="mt-8">
                                    <div class="setting-deatils">
                                        <div class="setting-icon">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="{{route('feedback')}}" class="mt-8">
                                    <div class="setting-deatils">
                                        <div class="setting-icon">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="{{route('contact-us')}}" class="mt-8">
                                    <div class="setting-deatils">
                                        <div class="setting-icon">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="setting-border mt-8"></div>
                                <a href="{{route('invite')}}" class="mt-8">
                                    <div class="setting-deatils">
                                        <div class="setting-icon">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                ...
                <nav>
                    <a href="{{route('Index')}}">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <mask id="mask0_330_3221" style="mask-type:alpha" 1maskUnits="userSpaceOnUse" x="0" y="0"
                                width="18" height="18">
                    ...
                    <a href="{{route('search-product')}}" class="active">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
