...
<body>
    ...
    <div class="homescreen-eight-bottom-full">
        <ul class="nav nav-pills mb-3 flex-row" id="homepage1-tab" role="tablist">
                    ...
                    @foreach($category->products as $product)
                        <div class="homepage1-tab-details-wrapper">
                            <div class="home1-tab-img">
                                <img style="width:127px;height:150px"src="{{ asset('uploads/images/' . $product->image) }}" alt="{{ $product->name }}">
                            </div>
                            <div class="home1-tab-details">
                                <div class="home1-tab-details-full">
                                    <p class="tab-home1-txt1">{{ $product->productName }}</p>
                                    <h3 class="tab-home1-txt2">${{ $product->productPrice }}</h3>
                                    <div class="orange-star-tab">
                                        ...
                                        <span class="tab-home1-txt3">{{ $product->rating }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="home1-tab-favourite">
                                <div class="home-page-arrival-favourite">
                                    <a href="javascript:void(0);" class="item-bookmark" tabindex="-1">
                                        <img src="{{ asset('assets/images/icons/unfill-heart.svg') }}" alt="Favorite">
                                    </a>
                                </div>
                                <div class="plus-bnt-home1">
                                    <a href="javascript:void(0)">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <!-- SVG content for plus icon -->
                                        </svg>
                                    </a>
                                </div>
                            </div>
