	...
	<div class="site-content">
						...
						<div class="container">
							<div class="homescreen-second-wrapper-top">
								...
								<div class="view-all-second">
									<a href="category-page.html"><p class="view-all-txt">View all<span><img src="{{asset('')}}assets/images/icons/view-all-icon.svg" alt="right-arrow"></span></p></a>
								</div>
							</div>
						</div>
						<div class="homescreen-second-wrapper-bottom mt-16">
							<div class="homescreen-second-wrapper-slider">
								<div class="category-slide redirect-clothes">
									<img src="{{asset('')}}assets/images/homescreen-1/category-1.png" alt="category-img">
								...
								<div class="category-slide redirect-electronic">
									<img src="{{asset('')}}assets/images/homescreen-1/category-2.png" alt="category-img">
									<div class="category-slide-content">
										<h4>Electronics</h4>
										<h5>845 Items</h5>
									</div>
								...
								<div class="category-slide redirect-clothes">
									<img src="{{asset('')}}assets/images/homescreen-1/category-3.png" alt="category-img"> 
									<div class="category-slide-content">
										<h4>Cosmetics</h4>
										<h5>286 Items</h5>
									</div>
					...
					<div class="homescreen-fourth-wrapper">
						<div class="container">
							<div class="homescreen-second-wrapper-top">
								...
								<div class="view-all-second">
									<a href="best-seller-screen.html"><p class="view-all-txt">View all<span><img src="{{asset('')}}assets/images/icons/view-all-icon.svg" alt="right-arrow"></span></p></a>
								</div>
							</div>
						</div>
							...
							<div class="homescreen-fourth-wrapper-slider">
								<div class="seller-slide redirect-clothes">
									<div class="seller-slide-top-content">
										<img src="{{asset('')}}assets/images/homescreen-1/seller-1.png" alt="seller-img">
									...
									<div class="seller-slide-bottom-content">
										...
										<div class="seller-bottom-price">
											...
											<div class="seller-bottom-price1">
												<span class="seller-star"><img src="{{asset('')}}assets/images/icons/orange-star.svg" alt="star-img"></span>
								...
								<div class="seller-slide redirect-electronic">
									<div class="seller-slide-top-content">
										<img src="{{asset('')}}assets/images/homescreen-1/seller-2.png" alt="seller-img">
										<div class="home-page-favourite">
					...
					<div class="homescreen-fifth-wrapper">
						<div class="container">
							<div class="homescreen-second-wrapper-top">
								...
								<div class="view-all-second">
									<a href="choose-brand.html"><p class="view-all-txt">View all<span><img src="{{asset('')}}assets/images/icons/view-all-icon.svg" alt="right-arrow"></span></p></a>
								</div>
							</div>
						</div>
							...
							<div class="homescreen-fifth-wrapper-slider">
								...
								<div class="brand-slide">
									<div class="brands-img">
										<img src="{{asset('')}}assets/images/homescreen-1/brand-1.png" alt="brand-img">
									</div>
								...
								<div class="brand-slide">
									<div class="brands-img">
										<img src="{{asset('')}}assets/images/homescreen-1/brand-2.png" alt="seller-img">
									</div>
									<div class="brands-content">
										<p>Samsung</p>
									</div>
								...
								<div class="brand-slide">
									<div class="brands-img">
										<img src="{{asset('')}}assets/images/homescreen-1/brand-3.png" alt="brand-img">
									</div>
									<div class="brands-content">
										<p>Intel</p>
									</div>
					...
					<div class="homescreen-sixth-wrapper">
						<div class="container">
							<div class="homescreen-second-wrapper-top">
								...
								<div class="view-all-second">
									<a href="single-electronics.html"><p class="view-all-txt">View all<span><img src="{{asset('')}}assets/images/icons/view-all-icon.svg" alt="right-arrow"></span></p></a>
								</div>
							</div>
						</div>
							...
							<div class="homescreen-sixth-wrapper-slider">
								<div class="featured-slide">
									<div class="featured-slide-top redirect-electronic">
										<img src="{{asset('')}}assets/images/homescreen-1/featured-1.png" alt="featured-img">
								...
								<div class="featured-slide">
									<div class="featured-slide-top redirect-electronic">
										<img src="{{asset('')}}assets/images/homescreen-1/featured-2.png" alt="featured-img">
										<div class="home-page-featured-favourite">
											<a href="javascript:void(0);" class="item-bookmark" tabindex="-1">
												<img src="{{asset('')}}assets/images/icons/unfill-heart.svg" alt="unfill-heart">
											</a>
								...
								<div class="featured-slide">
									<div class="featured-slide-top redirect-electronic ">
										<img src="{{asset('')}}assets/images/homescreen-1/featured-3.png" alt="featured-img">
										<div class="home-page-featured-favourite">
											<a href="javascript:void(0);" class="item-bookmark" tabindex="-1">
												<img src="{{asset('')}}assets/images/icons/unfill-heart.svg" alt="unfill-heart">
											</a>
					...
					<div class="homescreen-eight-wrapper">
						<div class="container">
							<div class="homescreen-second-wrapper-top">
								...
								<div class="view-all-second">
									<a href="arrivals.html"><p class="view-all-txt">View all<span><img src="{{asset('')}}assets/images/icons/view-all-icon.svg" alt="right-arrow"></span></p></a>
								</div>
							</div>
						</div>
											...
											<div class="homepage1-tab-details">
												<div class="homepage1-tab-details-wrapper">
													<div class="home1-tab-img">
														<img src="{{asset('')}}assets/images/homescreen-1/arrivals-1.png" alt="watch-img">
													</div>
												...
												<div class="homepage1-tab-details-wrapper">
													<div class="home1-tab-img">
														<img src="{{asset('')}}assets/images/homescreen-1/arrivals-2.png" alt="watch-img">
													</div>
													<div class="home1-tab-details">
														<div class="home1-tab-details-full">
												...
												<div class="homepage1-tab-details-wrapper">
													<div class="home1-tab-img">
														<img src="{{asset('')}}assets/images/homescreen-1/arrivals-3.png" alt="watch-img">
													</div>
													<div class="home1-tab-details">
														<div class="home1-tab-details-full">
												...
												<div class="homepage1-tab-details-wrapper">
													<div class="home1-tab-img">
														<img src="{{asset('')}}assets/images/homescreen-1/arrivals-4.png" alt="watch-img">
													</div>
													<div class="home1-tab-details">
														<div class="home1-tab-details-full">
												...
												<div class="homepage1-tab-details-wrapper">
													<div class="home1-tab-img">
														<img src="{{asset('')}}assets/images/homescreen-1/arrivals-5.png" alt="watch-img">
													</div>
													<div class="home1-tab-details">
														<div class="home1-tab-details-full">
															<p class="tab-home1-txt1">Baby Gift Pack Series,Pack of 1 set,white Baby Gift Pack Series, </p>
		...
		<div class="offcanvas offcanvas-bottom addtohome-popup theme-offcanvas" tabindex="-1" id="offcanvas" aria-modal="true" role="dialog">
			...
			<div class="offcanvas-body small">
				<img class="logo-popup" src="{{asset('')}}assets/images/splash-screen/logo.png" alt="logo">
