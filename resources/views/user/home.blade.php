...
<body>
    <div class="site-content">
                ...
                <div class="top-navbar_full">
                    ...
                    <div class="skip_btn notification-badge-btn">
                        <a href="notification.html">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <mask id="mask0_330_3241" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0"
                                    width="24" height="24">
                                    <rect width="24" height="24" fill="white" />
                                </mask>
        ...
        <!-- Header End -->
        <!-- Homepage 2 Screen Start -->
        <section id="home2-screen">
            <div class="home2-first-sec">
                <h1 class="d-none">HomeScreen2</h1>
                <div class="home2-first-sec-full">
                    <div id="carouselExampleIndicators1" class="carousel slide home2-first-slider"
                        data-bs-ride="carousel">
                        <div class="carousel-indicators">
                            <button type="button" data-bs-target="#carouselExampleIndicators1" data-bs-slide-to="0"
                                class="home2-first-slider-btn active" aria-current="true" aria-label="Slide 1"></button>
                            <button type="button" data-bs-target="#carouselExampleIndicators1" data-bs-slide-to="1"
                                class="home2-first-slider-btn" aria-label="Slide 2"></button>
                            <button type="button" data-bs-target="#carouselExampleIndicators1" data-bs-slide-to="2"
                                class="home2-first-slider-btn" aria-label="Slide 3"></button>
                        </div>
                            ...
                            <div class="carousel-item active">
                                <div class="home2-slider-item">
                                    ...
                                    <div class="home2-slider-img-content">
                                        ...
                                        <div class="home2-shop-btn mt-32">
            ...
            <div class="home2-second-sec mt-32">
                            ...
                            <div class="view-all-second">
                                <a href="single-electronics.html">
                                    <p class="view-all-txt">View all<span><img
                                                src="{{asset('')}}assets/images/icons/view-all-icon.svg"
            ...
            <div class="home3-third-sec mt-32">
                <div class="home2-third-sec-full">
                    <div class="container">
                        <div class="homescreen-second-wrapper-top">
                            <div class="categories-first">
                                <h2 class="home1-txt3">Top Categories</h2>
                            </div>
                            <div class="view-all-second">
            ...
            <div class="home4-fourth-sec mt-32">
                <div class="home4-fourth-sec-full">
                    <div id="carouselExampleIndicators" class="carousel slide carousel slide-shop-now2"
                        data-bs-ride="carousel">
                        <div class="carousel-indicators">
                            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0"
                                class="active home2-slider2-btn" aria-current="true" aria-label="Slide 1"></button>
                            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1"
                                class="home2-slider2-btn" aria-label="Slide 2"></button>
                            <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2"
                                class="home2-slider2-btn" aria-label="Slide 3"></button>
                        </div>
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="home2-slider2">
                                    <div class="container">
                                        <div class="home2-slider2-content">
                ...
                <div class="homescreen-fifth-wrapper">
                    ...
                    <div class="homescreen-fifth-wrapper-bottom mt-16">
                        <div class="homescreen-fifth-wrapper-slider">
                            ...
                            <div class="brand-slide">
                                <div class="brands-img">
                                    <img src="{{asset('')}}assets/images/homescreen-1/brand-2.png" alt="brand-img">
                                </div>
                                <div class="brands-content">
                                    <p>Samsung</p>
                                </div>
