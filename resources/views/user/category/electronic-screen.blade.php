				...
				<div class="shoes-screen-full mt-32">
					<div class="shoes-screen-wrapper electronic-redirect">
						<div class="shoes-screen-top">
							<div class="shoes-img">
								<img src="{{asset('')}}assets/images/shoes-screen/electronic-1.png" alt="shoes-img">
							</div>
						...
						<div class="shoes-screen-bottom">
							<div class="shoes-screen-bottom-full">
								<div class="shoes-screen-first">
									<h3>Go Buzz Bluetooth Calling Smart Watch, 1.69" Clear Display,</h3>
								</div>
					...
					<div class="shoes-screen-wrapper electronic-redirect">
						<div class="shoes-screen-top">
							<div class="shoes-img">
								<img src="{{asset('')}}assets/images/shoes-screen/electronic-2.png" alt="shoes-img">
							</div>
							<div class="clothes-favourite">
								<a href="javascript:void(0);" class="item-bookmark" tabindex="-1">
									<img src="{{asset('')}}assets/images/icons/unfill-heart.svg" alt="unfill-heart">
						...
						<div class="shoes-screen-bottom">
							<div class="shoes-screen-bottom-full">
								<div class="shoes-screen-first">
									<h3>Airdopes 141 Bluetooth Truly Wireless in Ear Earbuds with 42H</h3>
								</div>
								<div class="shoes-screen-second">
									<div class="cloth-txt1">
										<span>$850.00</span>
					...
					<div class="shoes-screen-wrapper electronic-redirect">
						<div class="shoes-screen-top">
							<div class="shoes-img">
								<img src="{{asset('')}}assets/images/shoes-screen/electronic-3.png" alt="shoes-img">
							</div>
							<div class="clothes-favourite">
								<a href="javascript:void(0);" class="item-bookmark" tabindex="-1">
									<img src="{{asset('')}}assets/images/icons/unfill-heart.svg" alt="unfill-heart">
						...
						<div class="shoes-screen-bottom">
							<div class="shoes-screen-bottom-full">
								<div class="shoes-screen-first">
									<h3>Spark 9 (Sky Mirror, 4GB RAM,64GB Storage) | 7GB Expandable RAM |</h3>
								</div>
								<div class="shoes-screen-second">
									<div class="cloth-txt1">
										<span>$275.00</span>
					...
					<div class="shoes-screen-wrapper electronic-redirect">
						<div class="shoes-screen-top">
							<div class="shoes-img">
								<img src="{{asset('')}}assets/images/shoes-screen/electronic-4.png" alt="shoes-img">
							</div>
							<div class="clothes-favourite">
								<a href="javascript:void(0);" class="item-bookmark" tabindex="-1">
									<img src="{{asset('')}}assets/images/icons/unfill-heart.svg" alt="unfill-heart">
						...
						<div class="shoes-screen-bottom">
							<div class="shoes-screen-bottom-full">
								<div class="shoes-screen-first">
									<h3>360 X3 Action Camera, 1/2" Sensor, 5.7K 360 Capture, Optical Zoom </h3>
								</div>
								<div class="shoes-screen-second">
									<div class="cloth-txt1">
										<span>$125.00</span>
					...
					<div class="shoes-screen-wrapper electronic-redirect">
						<div class="shoes-screen-top">
							<div class="shoes-img">
								<img src="{{asset('')}}assets/images/shoes-screen/electronic-5.png" alt="shoes-img">
							</div>
							<div class="clothes-favourite">
								<a href="javascript:void(0);" class="item-bookmark" tabindex="-1">
									<img src="{{asset('')}}assets/images/icons/unfill-heart.svg" alt="unfill-heart">
						...
						<div class="shoes-screen-bottom">
							<div class="shoes-screen-bottom-full">
								<div class="shoes-screen-first">
									<h3>Zeb-Warrior 4, 2.0 Speaker for PC, Laptops, Desktop with </h3>
								</div>
								<div class="shoes-screen-second">
									<div class="cloth-txt1">
										<span>$90.00</span>
					...
					<div class="shoes-screen-wrapper electronic-redirect">
						<div class="shoes-screen-top">
							<div class="shoes-img">
								<img src="{{asset('')}}assets/images/shoes-screen/electronic-6.png" alt="shoes-img">
							</div>
							<div class="clothes-favourite">
								<a href="javascript:void(0);" class="item-bookmark" tabindex="-1">
									<img src="{{asset('')}}assets/images/icons/unfill-heart.svg" alt="unfill-heart">
						...
						<div class="shoes-screen-bottom">
							<div class="shoes-screen-bottom-full">
								<div class="shoes-screen-first">
									<h3>Aquaman Edition Yoga N3 with 46 Hours Backup, Bluetooth</h3>
								</div>
								<div class="shoes-screen-second">
									<div class="cloth-txt1">
										<span>$50.00</span>
